...
<head>
    ...
    <title>Yahoo Finance - Trending Ticker</title>
...
function cookArrays(&$Names, &$Numbers, &$Merged){
        ...
        foreach($ACV as $Key => $Value){
                ...
                $sql = "INSERT INTO YF_Trend (TICKER_NAME,LAST_PRICE,TICKER_CHANGE,TICKER_CHANGE_PER,VOLUME,MARKET_CAP)
...
//Printing Datas
echo "<h2><font color=WHITE> Trending Tickers of Yahoo </font></h2>";

$sql = "SELECT * FROM YF_Trend ORDER BY TICKER_CHANGE_PER DESC;";
