...
<head>
    ...
    <title>MarketWatch - Most Gainer</title>
...
function getInfo($text){
    ...
    $sql = "INSERT INTO MW_Gain (TICKER_NAME,COMPANY_NAME,LAST_PRICE,TICKER_CHANGE,TICKER_CHANGE_PER,VOLUME,TRADED)
...
//Printing Datas
echo "<h2><font color=WHITE> Most Gained in MarketWatch </h2>";

$sql = "SELECT * FROM MW_Gain ORDER BY TICKER_CHANGE_PER DESC;";
